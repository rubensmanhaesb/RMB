...
namespace RMB.Core.Logs.Services
{
    ...
    /// </summary>
    internal class CallerEnricherService : ILogEventEnricher
    {
        private readonly ICallerInfoProvider _callerInfoProvider;

        /// <summary>
        /// Initializes a new instance of the <see cref="CallerEnricherService"/> class.
        /// </summary>
        /// <param name="callerInfoProvider">Service to retrieve caller information.</param>
        public CallerEnricherService(ICallerInfoProvider callerInfoProvider)
        {
