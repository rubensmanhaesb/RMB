...
namespace RMB.Core.Logs.Extensions
{
    ...
    public static class LoggingExtension 
    {
        ...
        public static void AddCustomLogging(this ILoggingBuilder loggingBuilder, string logName)
        {
            ...
            EventLogManagerExtension.EnsureEventSourceExists(logName); 
            ...
            Log.Logger = new LoggerConfiguration()
                ...
                .Enrich.With(new CallerEnricherService(new StackTraceCallerInfoProviderService())) // Adiciona o nome da classe e o método
                .WriteTo.EventLog(
